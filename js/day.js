...
(function () {
  ...
  const DEFAULT_WORK_ASSIGNMENTS = {
    ...
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|1반|count|승점 인원수 입력": "백애정",
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|2반|count|승점 인원수 입력": "강성자",
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|3반|count|승점 인원수 입력": "김선영",
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|4반|count|승점 인원수 입력": "성향숙",
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|5반|count|승점 인원수 입력": "최진영",
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|6반|count|승점 인원수 입력": "이애정",
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|7반|count|승점 인원수 입력": "이다원",
    "사제동행 가위바위보 릴레이|1학년|전체|학급별|8반|count|승점 인원수 입력": "문경덕",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|1반|count|승점 인원수 입력": "백애정",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|2반|count|승점 인원수 입력": "강성자",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|3반|count|승점 인원수 입력": "김선영",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|4반|count|승점 인원수 입력": "성향숙",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|5반|count|승점 인원수 입력": "최진영",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|6반|count|승점 인원수 입력": "이애정",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|7반|count|승점 인원수 입력": "이다원",
    "사제동행 가위바위보 릴레이|2학년|전체|학급별|8반|count|승점 인원수 입력": "문경덕",
